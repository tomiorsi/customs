...
/**
 * Cuentas del equipo: las personas del estudio que entran al panel.
 *
 * Solo empleados. El acceso de los clientes al portal se da desde la ficha del
 * cliente, que es donde el despachante ya está cuando se le ocurre dárselo —
 * tenerlo también acá obligaba a elegir el cliente de una lista y duplicaba el
 * mismo formulario en dos lugares.
 */
    ...
    <div className="grid gap-6 lg:grid-cols-[1fr_1.2fr]">
      ...
      >
        ...
        <p className="text-xs text-muted">
          Entra con su propio usuario y contraseña. Entregale los datos y que
          cambie la contraseña desde Mi cuenta.
        </p>
      ...
      <section className="overflow-hidden rounded-xl border border-border bg-surface">
        <div className="border-b border-border px-5 py-3">
          <h2 className="text-sm font-semibold text-foreground">
            En el estudio ({operadores.length})
          </h2>
        </div>
        {operadores.length === 0 ? (
          <div className="flex flex-col items-center justify-center px-6 py-12 text-center">
            ...
            <p className="mt-3 text-sm font-medium text-foreground">
              Por ahora trabajás solo
            </p>
            <p className="mt-1 max-w-xs text-xs text-muted">
              Sumá una cuenta por persona: cada uno entra con la suya y podés
              darla de baja sin tocar la de los demás.
            </p>
          </div>
        ) : (
