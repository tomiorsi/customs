...
export default function NoticiasLayout({ children }: { children: ReactNode }) {
  return (
    /* Mismo fondo que la portada: #fafbfd, el de wabe.dev. La parte pública
       tiene su color y el panel el suyo. */
    <div className="min-h-screen bg-[var(--portal-bg)] [--portal-bg:#fafbfd] dark:[--portal-bg:#0e2440]">
